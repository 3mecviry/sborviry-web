  ...
  news: [
    {
      ...
      text: {
        ...
        uk: 'У понеділок, 14 вересня 2026 року, о 18:00 запрошуємо до церкви Sbor Víry у Тршинці на ще один пророчий вечір — він продовжує торішній вечір 13 жовтня. На нас чекають прославлення, спільна молитва та пророчі слова. Прийти може будь-хто, вхід вільний і реєструватися заздалегідь не потрібно. Зустрічаємося за адресою Hraniční 213.',
        ru: 'В понедельник, 14 сентября 2026 года, в 18:00 приглашаем в церковь Sbor Víry в Тршинце на ещё один пророческий вечер — он продолжает прошлогодний вечер 13 октября. Нас ждут прославление, совместная молитва и пророческие слова. Прийти может любой, вход свободный и записываться заранее не нужно. Встречаемся по адресу Hraniční 213.',
        ...
        en: 'On Monday 14 September 2026 at 18:00 we invite you to Sbor Víry in Třinec for another prophetic evening — it follows on from the one we held here last October. There will be worship, time to pray together and prophetic words. Anyone is welcome, admission is free and there is no need to sign up in advance. We meet at Hraniční 213.',
        es: 'El lunes 14 de septiembre de 2026, a las 18:00, te invitamos a otra velada profética en la iglesia Sbor Víry de Třinec, que da continuidad a la del 13 de octubre del año pasado. Habrá alabanza y adoración, oración en común y palabras proféticas. Puede venir cualquiera, la entrada es libre y no hace falta inscribirse. Nos vemos en Hraniční 213.',
        ...
        hu: '2026. szeptember 14-én, hétfőn 18:00-tól újabb prófétai estre hívunk a třineci Sbor Víry gyülekezetbe — a tavalyi, október 13-i est folytatásaként. Dicséret és imádat, közös imádság és prófétai szavak várnak ránk. Bárki eljöhet, a belépés ingyenes, és előre nem kell jelentkezni. A Hraniční 213. szám alatt találkozunk.'
      }
    },
    {
      date: '2026-06-01',
