...
cs: {
  ...
  ministries: {
    hero: {
      ...
      p: 'Kromě nedělní bohoslužby se scházíme k modlitbám a každé pondělí vycházíme s evangeliem do centra Třince.'
    },
...
sk: {
  ...
  home: {
    ...
    times: {
      ...
      p: 'Hlavné stretnutie celého zboru je v nedeľu dopoludnia. Počas týždňa sa stretávame na modlitbách a vychádzame s evanjeliom do centra mesta.',
  ...
  ministries: {
    hero: {
      ...
      p: 'Okrem nedeľnej bohoslužby sa stretávame na modlitbách a každý pondelok vychádzame s evanjeliom do centra Třinca.'
    },
  ...
  contact: {
    ...
    form: {
      ...
      subject: 'Predmet',
      message: 'Vaša správa',
      subjectOptions: ['Všeobecná otázka', 'Chcem prísť prvýkrát', 'Prosba o modlitbu', 'Evanjelizácia', 'Iné'],
...
pl: {
  ...
  ministries: {
    hero: {
      ...
      p: 'Poza nabożeństwem niedzielnym spotykamy się na modlitwie, a w każdy poniedziałek wychodzimy z ewangelią do centrum Trzyńca.'
    },
...
uk: {
  ...
  home: {
    ...
    times: {
      ...
      p: 'Головна зустріч усієї церкви відбувається в неділю зранку. Протягом тижня ми збираємося на молитву й виходимо з Євангелієм у центр міста.',
  ...
  ministries: {
    hero: {
      ...
      p: 'Крім недільного богослужіння ми збираємося на молитву, а щопонеділка виходимо з Євангелієм у центр Тршинця.'
    },
  ...
  contact: {
    ...
    form: {
      ...
      subjectOptions: ['Загальне запитання', 'Хочу прийти вперше', 'Прохання про молитву', 'Євангелізація', 'Інше'],
...
ru: {
  ...
  home: {
    hero: {
      ...
      h1: 'Приходи таким, какой ты есть',
    ...
    times: {
      ...
      p: 'Главная встреча всей церкви проходит в воскресенье утром. В течение недели мы собираемся на молитву и выходим с Евангелием в центр города.',
  ...
  ministries: {
    hero: {
      ...
      p: 'Кроме воскресного богослужения мы собираемся на молитву, а каждый понедельник выходим с Евангелием в центр Тршинца.'
    },
  ...
  contact: {
    ...
    form: {
      ...
      subjectOptions: ['Общий вопрос', 'Хочу прийти впервые', 'Просьба о молитве', 'Евангелизация', 'Другое'],
...
de: {
  ...
  home: {
    ...
    times: {
      ...
      p: 'Das Haupttreffen der ganzen Gemeinde ist am Sonntagvormittag. Unter der Woche kommen wir zum Gebet zusammen und gehen mit dem Evangelium ins Stadtzentrum.',
  ...
  ministries: {
    hero: {
      ...
      p: 'Neben dem Sonntagsgottesdienst treffen wir uns zum Gebet und gehen jeden Montag mit dem Evangelium ins Zentrum von Třinec.'
    },
  ...
  contact: {
    ...
    form: {
      ...
      subjectOptions: ['Allgemeine Anfrage', 'Ich möchte zu Besuch kommen', 'Gebetsanliegen', 'Evangelisation', 'Sonstiges'],
...
en: {
  ...
  ministries: {
    hero: {
      ...
      p: 'Besides the Sunday service we meet to pray, and every Monday we take the gospel into the centre of Třinec.'
    },
    m1t: 'Sunday service',
...
es: {
  ...
  ministries: {
    hero: {
      ...
      p: 'Además del culto dominical nos reunimos para orar y cada lunes salimos con el evangelio al centro de Třinec.'
    },
    m1t: 'Culto dominical',
