...
Statický web v **osmi jazycích** (čeština, slovenština, polština, ukrajinština,
ruština, němčina, angličtina, španělština).
...
napište si o jeho vrácení — jde o jedno tlačítko a jeden text v osmi jazycích.
...
Web je v **osmi jazycích**. Přepínač je vpravo v hlavičce; volba se ukládá do
...
jazyk s azbukou, dopište jeho kód i tam.
